...
const DocumentCard: React.FC<DocumentCardProps> = ({ title, subTitle, description }) => {
  return (
    <div className='z-10 bg-white relative max-h-[266px] rounded-[20px] px-4 py-3 md:p-5 xl:p-6 2xl:p-7'>
      ...
      <div className='p-2 md:p-3 xl:p-4 2xl:p-5 bg-[#9DCCFF] bg-opacity-20 mt-4 md:mt-5 xl:mt-6 2xl:mt-7'>
        <p className='text-sm md:text-base text-[#696984] max-h-[75px] overflow-hidden text-ellipsis'>
          {description}
        </p>
      </div>
    </div>
