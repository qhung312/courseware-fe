...
const LoginButton: FC = () => {
  ...
  return (
    <button
      ...
      className='relative flex w-fit cursor-pointer flex-row items-center justify-between gap-x-4 rounded-lg border border-[#CCC] bg-white px-8
      py-2 shadow-[0_1px_1px_0_rgba(47,50,125,0.1)] transition-all duration-300 
