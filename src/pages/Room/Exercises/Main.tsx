              ...
              {isFetchingQuizzes ? (
                ...
                quizzes?.map((quiz, index) => (
                  <div
                    ...
                    key={`${quiz.name}-${index}`}
                    className='flex cursor-pointer flex-col rounded-lg border-[1px] border-[#dadce0] bg-white p-3 hover:shadow-[0px_10px_40px_0px_rgba(66,133,244,0.1)] md:p-4 lg:p-6 3xl:p-8'
                  >
