...
const CHAPTERS = [
  ...
  {
    name: 'Tich phan 1 bien',
    subject: 'giai tich 1',
    createdAt: '28/07/2023, 18:03',
    lastUpdatedAt: '28/07/2023, 18:03',
  },
  {
    name: 'Tich phan nhieu bien',
    subject: 'giai tich 2',
    createdAt: '28/07/2023, 18:03',
    lastUpdatedAt: '28/07/2023, 18:03',
  },
...
const ChapterListPage = () => {
  ...
  const [chunks, setChunks] = useState(_.chunk(CHAPTERS, ITEMS_PER_PAGE));
  ...
  useEffect(() => {
    const newExercises = CHAPTERS.filter((exercise) =>
