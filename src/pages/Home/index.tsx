...
import { CarouselArrow, CarouselIndicator, Icon } from '../../components';
      ...
      >
        ...
        >
          ...
          <p className='text-[12px] leading-relaxed md:text-[16px] xl:text-[24px]'>
            <strong>Chúng Ta Cùng Tiến</strong> là Câu lạc bộ học thuật được thành lập dưới sự quản
            lý của Trung tâm Hỗ trợ Sinh viên và Việc làm.
          </p>
          <p className='text-[12px] leading-relaxed md:text-[16px] xl:text-[24px]'>
          ...
          <p className='text-[12px] leading-relaxed md:text-[16px] xl:text-[24px]'>
            ...
            <strong>SỰ KIỆN</strong>; và Thân thiện, hài hòa trong <strong>NHÂN SỰ HẬU CẦN</strong>.
          </p>
        </div>
      </section>
      <section
