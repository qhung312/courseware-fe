        ...
        <div className='mb-16 flex w-full flex-col gap-y-0 px-5 md:gap-y-12 md:px-[48px] lg:mb-24 lg:gap-y-20 lg:px-24 2xl:mb-32 2xl:gap-y-24 2xl:px-32 3xl:mb-36 3xl:gap-y-28 3xl:px-40'>
          ...
          <div className='flex flex-col gap-y-[54px] md:gap-y-8 lg:gap-y-10 2xl:gap-y-12 3xl:gap-y-[60px]'>
            ...
            <div className='flex w-full justify-start'>
              <div className='flex w-full flex-col justify-between rounded-[20px] bg-transparent shadow-xl md:aspect-[37/8] md:w-[64%] md:flex-row md:overflow-x-hidden'>
                <div className='relative h-full w-full items-start px-4 md:flex md:flex-row md:gap-x-3 lg:gap-x-5 lg:px-6 2xl:gap-x-7 2xl:px-8 3xl:px-9'>
                  {width > 768 ? (
                  ...
                  <div className='flex h-full w-full items-start bg-transparent py-3 pt-9 md:pt-0 lg:py-4 2xl:py-6 3xl:py-7'>
                    <p className='text-[16px] font-normal leading-7 text-[#696984] md:leading-6 lg:text-xl lg:leading-8 2xl:text-[22px] 2xl:leading-10 3xl:text-[24px]'>
                      ...
                      biểu như các buổi chia sẻ phương pháp học tập, định hướng phát triển cho Tân
                      sinh viên của từng khóa.
                    </p>
                  </div>
                </div>
                <div className='h-full w-full rounded-none p-0 md:aspect-[4/3] md:h-full'>
                  <LazyLoadImage
                    className='z-[1] block rounded-b-[20px] md:aspect-[4/3] md:h-full md:w-auto md:rounded-none'
            ...
            <div className='flex w-full justify-end'>
              <div className='flex w-full flex-col justify-between rounded-[20px] bg-transparent shadow-xl md:aspect-[250/49] md:w-[75%] md:translate-x-[4%] md:flex-row md:overflow-x-hidden'>
                <div className='relative h-full w-full items-start px-4 md:flex md:flex-row md:gap-x-3 lg:gap-x-5 lg:px-6 2xl:gap-x-7 2xl:px-8 3xl:px-9'>
                  {width > 768 ? (
                    <div className='flex w-fit items-start py-4 lg:py-6 2xl:py-8 3xl:py-9'>
                      <div className='flex aspect-square items-center justify-center rounded bg-[#00CBB8]/30 md:h-12 lg:h-16 2xl:h-20 3xl:h-[90px]'>
                  ...
                  <div className='flex h-full w-full items-start bg-transparent py-3 pt-9 md:pt-0 lg:py-4 2xl:py-6 3xl:py-7'>
                    <p className='text-[16px] font-normal leading-7 text-[#696984] md:leading-6 lg:text-xl lg:leading-8 2xl:text-[22px] 2xl:leading-10 3xl:text-[24px]'>
                      ...
                      những ngày đầu đặt chân đến Thành phố. Điều này giúp các bạn và phụ huynh tiết
                      kiệm thời gian và công sức vì những điều mới lạ trong quá trình nhập học.
                    </p>
                  </div>
                </div>
                <div className='h-full w-full p-0 md:aspect-[26/17] md:h-full'>
                  <LazyLoadImage
                    className='z-[1] block rounded-b-[20px] md:h-full md:w-auto md:rounded-none'
